...
public abstract @Data class AbstractIndustry {
  ...
  public static void buyIndustry(
    ...
    contentPanel.addComponent(
        new Label(gameProperties.langMap.get("youAreOwnerOfIndustry") + ": "));
  ...
  public static void buyProduct(
    ...
    gameProperties.oilfields[selectedOilfieldIndex].addProductAmount(
        industryType, selectedProductAmount);
